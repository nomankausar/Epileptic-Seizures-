...
folder_path = r"C:\Engel 1 Subjects\New folder (4)"
...
plt.title("EZ vs Non-EZ MFDFA Analysis")
...
plt.legend(handles, ["Non-EZ ", "EZ "], title="SOZ")
...
plt.savefig("Hurst_exponent_corrected.png", dpi=1200)
